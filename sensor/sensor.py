class Sensor:
    ...
    SENSITIVITY = None          # Int - Sensitivity of the sensor to light and movement? TODO check docs
    LED = None                  # Boolean - Status of the LED
    TYPE = None                 # String - Type of the sensor TODO check docs for different types
    MODEL_ID = None             # String - Model ID of the sensor (not unique)
    UNIQUE_ID = None            # String - Unique ID (like a MAC address) TODO check what kind of ID this is
